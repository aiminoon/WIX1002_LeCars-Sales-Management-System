...
public class ViewProfitMargin {
    ...
    public static double calculateProfitMargin() {
        ...
        try {
            ...
            System.out.println("An error occured while calculating company profit margin.");
            e.printStackTrace();  
        }
        ...
        return totalSalesPrice - totalAquirePrice - totalSalaryEmployee - rent - utility - tax;
    }
}
